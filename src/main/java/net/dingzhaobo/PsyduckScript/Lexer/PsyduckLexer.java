...
public class PsyduckLexer implements Lexer {
    @NonNull
    ...
    public List<LexerResult> tokenization() throws PsyduckException {
        List<LexerResult> results = new ArrayList<LexerResult>();

        LexerResult lexerResult = analyze();
    ...
    private LexerResult analyze() throws PsyduckSyntaxError {
        try {
            char next = getNext();
